...
var RequestView = Backbone.View.extend({
  ...
  changeForm: function (evt) {
    ...
    var maxDistance = $('#mode').val().indexOf('WALK') !== -1 ?
      $("#maxWalkDistance option[selected]").val() : $('#maxBikeDistance option[selected]').val()
    /* Ed hack: see if I can always set this to another number. 2016-09-07 */
    // var maxDistance = 8888;
